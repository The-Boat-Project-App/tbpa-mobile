          ...
          <Modal.Content maxWidth={width} maxH={height * 0.8}>
            ...
            <Modal.Body>
              ...
              <Text className='mb-2 text-xs text-justify font-raleway text-deepBlue'>
                ...
                du Lion, les Îles Baléares, la Mer du Ponant, le Cap de la Nau, Cap de Palos, la Mer
          ...
          <Modal.Content maxWidth={width} maxH={height * 0.8}>
            ...
            <Modal.Body>
              ...
              <Text className='mb-2 text-xs text-justify font-raleway text-deepBlue'>
                ...
                avant de faire escale au port de Barcelone. Là bas, le musée Maritime participera à
                nous donner des clefs de lecture sur la méditerranée. Nous pourrons confronter notre
                expérience de navigation à celles que nous découvrirons dans ce musée.
              </Text>
            </Modal.Body>
          </Modal.Content>
        </Modal>
          ...
          <Modal.Content maxWidth={width} maxH={height * 0.8}>
            ...
            <Modal.Body>
              <Text className='mb-2 text-xs text-justify font-raleway text-deepBlue'>
                ...
                Pendant plusieurs jours, nous traverserons le bassin algéro-provençal. C’est durant
                cette étape que nous serons les plus éloignés de la terre ferme.
              </Text>
              <Text className='mb-2 text-xs text-justify font-raleway text-deepBlue'>
                ...
                nous montrera l’activité nocturne qui s’y déroule et nous pourrons aller participer
                aux festivités qui accompagnent l’iftar.
              </Text>
            </Modal.Body>
          </Modal.Content>
        </Modal>
          ...
          <Modal.Content maxWidth={width} maxH={height * 0.8}>
            ...
            <Modal.Body>
              <Text className='mb-2 text-xs text-justify font-raleway text-deepBlue'>
                ...
                permettra de faire le point sur notre retour à Marseille que nous aurons quitté cinq
                mois auparavant. En laissant derrière nous la mer ligurienne, nous dépasserons
                Cannes, Hyère, Toulon avant de retrouver la cité phocéenne.
              </Text>
            </Modal.Body>
          </Modal.Content>
        </Modal>
